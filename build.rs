fn main() {
    ...
    // Source language is Chinese (the msgids); `lang/<lc>/LC_MESSAGES/probe-shell.po`
    ...
    #[cfg(windows)]
    {
        println!("cargo:rerun-if-changed=assets/probe-shell.ico");
        println!("cargo:rerun-if-changed=assets/probe-shell.exe.manifest");
        let mut res = winresource::WindowsResource::new();
        res.set_icon("assets/probe-shell.ico");
        ...
        res.set_manifest_file("assets/probe-shell.exe.manifest");
