...
- 🐛 **报告 Bug**：在 [Issues](https://github.com/OnlyChallgener/probe-shell/issues) 里描述复现步骤、系统环境和期望行为。
...
- 🐛 **Report bugs**: open an [Issue](https://github.com/OnlyChallgener/probe-shell/issues)
